...
ipmi::RspType<uint16_t> ipmiStorageAddSELEntry(std::vector<uint8_t> data)
{
    ...
    /* Parse sel data and get a Error log to be filed */
    ...
    phosphor::logging::log<phosphor::logging::level::INFO>(
        journalMsg.c_str(),
        phosphor::logging::entry("MESSAGE_ID=%s", messageID.c_str()),
        phosphor::logging::entry("MESSAGE_ARGS=%s", messageArgsString.c_str()));
