...
int frame::append (const char *string, int indent)
{
  ...
  pages = (lines / line_per_page) +
    ((lines % line_per_page)?1:0);
...
static int udbg_get_cri_sensor (uint8_t frame, uint8_t page,
						uint8_t *next, uint8_t *count, uint8_t *buffer)
{
...
static int udbg_get_info_page (uint8_t frame, uint8_t page,
						uint8_t *next, uint8_t *count, uint8_t *buffer)
{
...
int plat_udbg_get_frame_data(uint8_t frame, uint8_t page,
					uint8_t *next, uint8_t *count, uint8_t *buffer)
{
  switch (frame) {
    case 1: //info_page
