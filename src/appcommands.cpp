...
//----------------------------------------------------------------------
// Cold Reset (IPMI/Section 20.2) (CMD_APP_COLD_RESET)
//----------------------------------------------------------------------
ipmi_ret_t ipmiAppColdReset(ipmi_netfn_t netfn, ipmi_cmd_t cmd,
                            ipmi_request_t request, ipmi_response_t response,
                            ipmi_data_len_t data_len, ipmi_context_t context)
{
    /* TODO: Check for going FW upgrade or crashdump or cplddump */
    *data_len = 0;

    phosphor::logging::log<phosphor::logging::level::ERR>("BMC Cold Reset.");
    reboot(RB_AUTOBOOT);
    return IPMI_CC_OK;
}
...
void registerAPPFunctions()
{
    ...
    ipmiPrintAndRegister(NETFUN_APP, CMD_APP_COLD_RESET, NULL, ipmiAppColdReset,
                         PRIVILEGE_USER); // Cold Reset
